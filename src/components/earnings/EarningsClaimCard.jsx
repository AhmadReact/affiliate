...
export default function EarningsClaimCard() {
  return (
    <div className="bg-gradient-to-br from-blue-50 to-white rounded-xl border border-blue-100 p-6 shadow-sm">
      ...
      <p className="text-4xl font-bold text-gray-800 mt-1">$568.25</p>
      ...
      <div className="mt-6 flex items-center justify-end gap-2 border-t border-blue-100 pt-4">
        ...
        <span className="ml-auto text-sm font-bold text-gray-700">$568.25</span>
      </div>
    </div>
  );
}
